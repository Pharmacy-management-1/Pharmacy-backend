        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DosageForm = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Strength = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Packaging = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeasonalOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeasonalOffers_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthPackageItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthPackageItems_HealthPackages_HealthPackageId",
                        column: x => x.HealthPackageId,
                        principalTable: "HealthPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HealthPackageItems_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(255)", nullable: false, defaultValue: "Pending")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AdminComments = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthPackageItems_HealthPackageId",
                table: "HealthPackageItems",
                column: "HealthPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthPackageItems_ProductId",
                table: "HealthPackageItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeasonalOffers_CategoryId",
